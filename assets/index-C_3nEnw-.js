import { g as Et, d as It, e as St, f as vt } from "./index-6nMvIxqd.js";
import {
  D as be,
  g as R,
  c as ee,
...
const D = {
  ...
  Ze = "Unspecified error message.",
  Ct = "Unspecified server error.";
function Ee(t, e = Ze) {
  if (t && Number.isInteger(t)) {
    const n = t.toString();
    if (ye(we, n)) return we[n].message;
    if (Xe(t)) return Ct;
  }
  return e;
}
  ...
  if (
    ...
    (n.code = s.code),
      s.message && typeof s.message == "string"
        ? ((n.message = s.message), ye(s, "data") && (n.data = s.data))
        : ((n.message = Ee(n.code)), (n.data = { originalError: Le(t) }));
  } else
    (n.code = D.rpc.internal),
      (n.message = xe(t, "message") ? t.message : Ze),
      (n.data = { originalError: Le(t) });
...
function Pt(t, e = !1) {
  if (typeof t == "string") {
    ...
    if (it.test(n)) return se(e ? `0x${n}` : n);
  }
...
function F(t) {
  if (typeof t == "string") {
    const e = ve(t).toLowerCase();
    if (oe(e) && e.length === 40) return Mt(at(e));
  }
...
const de = { storageKey: "ownPrivateKey", keyType: "private" },
  ...
  le = { storageKey: "peerPublicKey", keyType: "public" };
class qt {
  constructor() {
  ...
  async generateKeyPair() {
    ...
    (this.ownPrivateKey = e.privateKey),
      ...
      await this.storeKey(ue, e.publicKey);
  }
  async loadKeysIfNeeded() {
    if (
      ...
      this.ownPublicKey === null &&
        (this.ownPublicKey = await this.loadKey(ue)),
      (this.ownPrivateKey === null || this.ownPublicKey === null) &&
        (await this.generateKeyPair()),
      this.peerPublicKey === null &&
        (this.peerPublicKey = await this.loadKey(le)),
      this.sharedSecret === null)
    ) {
...
function zt({ metadata: t, preference: e }) {
  ...
  if (d != null && d.isCoinbaseBrowser)
    return (
      (s = d.setAppInfo) === null || s === void 0 || s.call(d, r, i, a, e), d
    );
}
function Ft(t) {
  if (!t || typeof t != "object" || Array.isArray(t))
...
class Gt {
  constructor(e) {
    ...
    (this.metadata = e.metadata),
      ...
      (this.accounts =
        (n = this.storage.loadObject(Me)) !== null && n !== void 0 ? n : []),
      (this.chain = this.storage.loadObject(Re) || {
        id:
          (r =
  ...
  async request(e) {
    var n;
    if (this.accounts.length === 0) throw A.provider.unauthorized();
    switch (e.method) {
  ...
  async createRequestMessage(e) {
    const n = await ct("public", await this.keyManager.getOwnPublicKey());
    return {
      id: crypto.randomUUID(),
      sender: n,
      content: e,
  ...
  async decryptResponseMessage(e) {
    ...
    if (d) {
      const f = Object.entries(d).map(([m, I]) => ({
        id: Number(m),
        rpcUrl: I,
      }));
      this.storage.storeObject(Pe, f), this.updateChain(this.chain.id, f);
    }
    const l = (s = a.data) === null || s === void 0 ? void 0 : s.capabilities;
    return l && this.storage.storeObject(Te, l), a;
  }
  updateChain(e, n) {
    var s;
    ...
    return i
      ? (i !== this.chain &&
          ((this.chain = i),
          this.storage.storeObject(Re, i),
          (s = this.callback) === null ||
            s === void 0 ||
            s.call(this, "chainChanged", Y(i.id))),
        !0)
      : !1;
  }
}
...
function ht() {
  ...
  function n(a, ...d) {
    ...
    if (d.length > 0 && !d.includes(a.length))
      throw new Error(
        "Uint8Array expected of length " + d + ", got length=" + a.length
      );
  }
  function s(a) {
...
function Yt() {
  ...
  function s(g, p = !1) {
    let o = new Uint32Array(g.length),
      b = new Uint32Array(g.length);
    for (let v = 0; v < g.length; v++) {
      const { h: C, l: N } = n(g[v], p);
      [o[v], b[v]] = [C, N];
    }
    return [o, b];
  }
  ...
  function L(g, p, o, b) {
    const v = (p >>> 0) + (b >>> 0);
    return { h: (g + o + ((v / 2 ** 32) | 0)) | 0, l: v | 0 };
  }
  const x = (g, p, o) => (g >>> 0) + (p >>> 0) + (o >>> 0);
  E.add3L = x;
  const P = (g, p, o, b) => (p + o + b + ((g / 2 ** 32) | 0)) | 0;
  E.add3H = P;
  const y = (g, p, o, b) => (g >>> 0) + (p >>> 0) + (o >>> 0) + (b >>> 0);
  E.add4L = y;
  const w = (g, p, o, b, v) => (p + o + b + v + ((g / 2 ** 32) | 0)) | 0;
  E.add4H = w;
  const S = (g, p, o, b, v) =>
    (g >>> 0) + (p >>> 0) + (o >>> 0) + (b >>> 0) + (v >>> 0);
  E.add5L = S;
  const M = (g, p, o, b, v, C) => (p + o + b + v + C + ((g / 2 ** 32) | 0)) | 0;
  E.add5H = M;
  const T = {
    fromBig: n,
    split: s,
  ...
  return (
    je ||
      ...
      (function (t) {
        ...
        t.byteSwapIfBE = t.isLE ? (o) => o : (o) => f(o);
        function m(o) {
          for (let b = 0; b < o.length; b++) o[b] = f(o[b]);
        }
        const I = Array.from({ length: 256 }, (o, b) =>
          b.toString(16).padStart(2, "0")
        );
        function u(o) {
          (0, n.abytes)(o);
          let b = "";
          for (let v = 0; v < o.length; v++) b += I[o[v]];
          return b;
        }
        ...
        function _(o) {
          ...
          if (b % 2)
            throw new Error(
              "hex string expected, got unpadded hex of length " + b
            );
          const C = new Uint8Array(v);
          for (let N = 0, U = 0; N < v; N++, U += 2) {
            const $ = h(o.charCodeAt(U)),
              Ce = h(o.charCodeAt(U + 1));
            if ($ === void 0 || Ce === void 0) {
              const kt = o[U] + o[U + 1];
              throw new Error(
        ...
        const k = async () => {};
        t.nextTick = k;
        async function L(o, b, v) {
          let C = Date.now();
          for (let N = 0; N < o; N++) {
            v(N);
            const U = Date.now() - C;
            (U >= 0 && U < b) || (await (0, t.nextTick)(), (C += U));
          }
        }
        function x(o) {
          if (typeof o != "string")
        ...
        function y(...o) {
          ...
          for (let C = 0; C < o.length; C++) {
            const N = o[C];
            (0, n.abytes)(N), (b += N.length);
          }
          const v = new Uint8Array(b);
          for (let C = 0, N = 0; C < o.length; C++) {
            const U = o[C];
            v.set(U, N), (N += U.length);
          }
          return v;
        }
        class w {
        ...
        function M(o) {
          const b = (C) => o().update(P(C)).digest(),
            v = o();
          return (
            (b.outputLen = v.outputLen),
            (b.blockLen = v.blockLen),
            (b.create = () => o()),
            b
          );
        }
        function T(o) {
          const b = (C, N) => o(N).update(P(C)).digest(),
            v = o({});
          return (
            (b.outputLen = v.outputLen),
            (b.blockLen = v.blockLen),
...
function Jt() {
  ...
  const t = ht(),
    ...
    m = BigInt(256),
    I = BigInt(113);
  for (let y = 0, w = d, S = 1, M = 0; y < 24; y++) {
    ([S, M] = [M, (2 * S + 3 * M) % 5]),
      s.push(2 * (5 * M + S)),
      r.push((((y + 1) * (y + 2)) / 2) % 64);
    let T = a;
    for (let g = 0; g < 7; g++)
      (w = ((w << d) ^ ((w >> f) * I)) % m),
        w & l && (T ^= d << ((d << BigInt(g)) - d));
    i.push(T);
  }
  const [u, c] = (0, e.split)(i, !0),
    h = (y, w, S) => (S > 32 ? (0, e.rotlBH)(y, w, S) : (0, e.rotlSH)(y, w, S)),
    _ = (y, w, S) => (S > 32 ? (0, e.rotlBL)(y, w, S) : (0, e.rotlSL)(y, w, S));
  function k(y, w = 24) {
    const S = new Uint32Array(10);
    for (let M = 24 - w; M < 24; M++) {
      for (let p = 0; p < 10; p++)
        S[p] = y[p] ^ y[p + 10] ^ y[p + 20] ^ y[p + 30] ^ y[p + 40];
      ...
      for (let p = 0; p < 24; p++) {
        const o = r[p],
          ...
          v = _(T, g, o),
          C = s[p];
        (T = y[C]), (g = y[C + 1]), (y[C] = b), (y[C + 1] = v);
      }
      for (let p = 0; p < 50; p += 10) {
        for (let o = 0; o < 10; o++) S[o] = y[p + o];
        for (let o = 0; o < 10; o++)
          y[p + o] ^= ~S[(o + 2) % 10] & S[(o + 4) % 10];
      }
      (y[0] ^= u[M]), (y[1] ^= c[M]);
    }
    S.fill(0);
  ...
  class L extends n.Hash {
    ...
    update(w) {
      (0, t.aexists)(this);
      const { blockLen: S, state: M } = this;
      w = (0, n.toBytes)(w);
      const T = w.length;
      for (let g = 0; g < T; ) {
        const p = Math.min(S - this.pos, T - g);
        for (let o = 0; o < p; o++) M[this.pos++] ^= w[g++];
    ...
    finish() {
      ...
      this.finished = !0;
      const { state: w, suffix: S, pos: M, blockLen: T } = this;
      (w[M] ^= S),
        S & 128 && M === T - 1 && this.keccak(),
        (w[T - 1] ^= 128),
        this.keccak();
    }
    writeInto(w) {
      ...
      for (let T = 0, g = w.length; T < g; ) {
        ...
        const p = Math.min(M - this.posOut, g - T);
        w.set(S.subarray(this.posOut, this.posOut + p), T),
          (this.posOut += p),
          (T += p);
      }
      return w;
    ...
    _cloneInto(w) {
      ...
      return (
        w || (w = new L(S, M, T, p, g)),
        w.state32.set(this.state32),
        (w.pos = this.pos),
        (w.posOut = this.posOut),
        (w.finished = this.finished),
        (w.rounds = g),
        (w.suffix = M),
        (w.outputLen = T),
        (w.enableXOF = p),
        (w.destroyed = this.destroyed),
        w
      );
    }
  }
  O.Keccak = L;
  const x = (y, w, S) => (0, n.wrapConstructor)(() => new L(w, y, S));
  ...
  const P = (y, w, S) =>
    (0, n.wrapXOFConstructorWithOpts)(
      (M = {}) => new L(w, y, M.dkLen === void 0 ? S : M.dkLen, !0)
    );
  return (
    (O.shake128 = P(31, 168, 128 / 8)), (O.shake256 = P(31, 136, 256 / 8)), O
  );
}
var fe, Be;
function ft() {
  ...
  function d(c) {
    if (!Buffer.isBuffer(c))
      if (Array.isArray(c)) c = Buffer.from(c);
        ...
        I(c) ? (c = Buffer.from(m(u(c)), "hex")) : (c = Buffer.from(c));
...
function Qt() {
  ...
  function i(u) {
    var c = typeof u;
    if (c === "string" || c === "number") return BigInt(u);
    if (c === "bigint") return u;
    throw new Error("Argument is not a number");
  }
  function a(u, c) {
    var h, _, k, L;
    if (u === "address") return a("uint160", i(c));
    if (u === "bool") return a("uint8", c ? 1 : 0);
    if (u === "string") return a("bytes", new Buffer(c, "utf8"));
    if (l(u)) {
      if (typeof c.length > "u") throw new Error("Not an array?");
      if (((h = r(u)), h !== "dynamic" && h !== 0 && c.length > h))
        throw new Error("Elements exceed array size: " + h);
      (k = []),
        (u = u.slice(0, u.lastIndexOf("["))),
        typeof c == "string" && (c = JSON.parse(c));
      for (L in c) k.push(a(u, c[L]));
      if (h === "dynamic") {
      ...
      if (u === "bytes")
        return (
          (c = new Buffer(c)),
          (k = Buffer.concat([a("uint256", c.length), c])),
          c.length % 32 !== 0 &&
            (k = Buffer.concat([k, t.zeros(32 - (c.length % 32))])),
          k
        );
      if (u.startsWith("bytes")) {
        ...
        return (h = s(u)), a("int256", i(c) * BigInt(2) ** BigInt(h[1]));
    }
  ...
  function f(u, c) {
    ...
    for (var L in u) {
      var x = e(u[L]),
        P = c[L],
        y = a(x, P);
      d(x) ? (h.push(a("uint256", k)), _.push(y), (k += y.length)) : h.push(y);
    }
  ...
  function m(u, c) {
    ...
    for (var h, _, k = [], L = 0; L < u.length; L++) {
      var x = e(u[L]),
        P = c[L];
      if (x === "bytes") k.push(P);
      else if (x === "string") k.push(new Buffer(P, "utf8"));
      else if (x === "bool") k.push(new Buffer(P ? "01" : "00", "hex"));
      else if (x === "address") k.push(t.setLength(P, 20));
      else if (x.startsWith("bytes")) {
        if (((h = n(x)), h < 1 || h > 32))
          throw new Error("Invalid bytes<N> width: " + h);
        k.push(t.setLengthRight(P, h));
      } else if (x.startsWith("uint")) {
        if (((h = n(x)), h % 8 || h < 8 || h > 256))
          throw new Error("Invalid uint<N> width: " + h);
        _ = i(P);
  ...
  function I(u, c) {
    return t.keccak(m(u, c));
  }
  return (pe = { rawEncode: f, solidityPack: m, soliditySHA3: I }), pe;
}
var ge, qe;
function Zt() {
  if (qe) return ge;
    ...
    s = {
      encodeData(i, a, d, l = !0) {
        ...
        if (l) {
            ...
            if (d[c] !== void 0)
              return [
                ...
                h == null
                  ...
                  : t.keccak(this.encodeData(c, h, d, l)),
              ];
            if (h === void 0)
              throw new Error(`missing value for field ${u} of type ${c}`);
          ...
          for (const u of d[i]) {
            const [c, h] = I(u.name, u.type, a[u.name]);
            f.push(c), m.push(h);
          }
        } else
          for (const I of d[i]) {
            ...
            if (u !== void 0)
              if (I.type === "bytes")
                ...
                f.push("bytes32"),
                  ...
                  (u = t.keccak(u)),
                  m.push(u);
              else if (d[I.type] !== void 0)
                f.push("bytes32"),
                  (u = t.keccak(this.encodeData(I.type, u, d, l))),
                  m.push(u);
              else {
      ...
      encodeType(i, a) {
        ...
        for (const f of l) {
          ...
          d +=
            f +
            "(" +
            a[f].map(({ name: I, type: u }) => u + " " + I).join(",") +
            ")";
        }
        return d;
      },
      findTypeDependencies(i, a, d = []) {
        if (((i = i.match(/^\w*/)[0]), d.includes(i) || a[i] === void 0))
          return d;
        d.push(i);
        for (const l of a[i])
          for (const f of this.findTypeDependencies(l.type, a, d))
            !d.includes(f) && d.push(f);
        return d;
      },
      hashStruct(i, a, d, l = !0) {
        return t.keccak(this.encodeData(i, a, d, l));
      },
      hashType(i, a) {
      ...
      hash(i, a = !0) {
        ...
        return (
          l.push(this.hashStruct("EIP712Domain", d.domain, d.types, a)),
          d.primaryType !== "EIP712Domain" &&
            l.push(this.hashStruct(d.primaryType, d.message, d.types, a)),
...
class nn {
  ...
  async encrypt(e) {
    ...
    const s = crypto.getRandomValues(new Uint8Array(12)),
      ...
      d = 16,
      l = a.slice(a.byteLength - d),
      f = a.slice(0, a.byteLength - d),
      m = new Uint8Array(l),
      I = new Uint8Array(f),
      u = new Uint8Array([...s, ...m, ...I]);
    return Se(u);
  }
  async decrypt(e) {
    const n = this.secret;
    ...
    return new Promise((s, r) => {
      (async function () {
        const i = await crypto.subtle.importKey(
          ...
          l = a.slice(12, 28),
          f = a.slice(28),
          m = new Uint8Array([...f, ...l]),
          I = { name: "AES-GCM", iv: new Uint8Array(d) };
        try {
          const u = await window.crypto.subtle.decrypt(I, i, m),
            c = new TextDecoder();
          s(c.decode(u));
        } catch (u) {
          r(u);
        ...
        (r.onmessage = (i) => {
          ...
          if (i.data === "h")
            ...
            try {
              ...
              (d = this.incomingDataListener) === null ||
                d === void 0 ||
                d.call(this, l);
            } catch {}
        });
...
class on {
    ...
    (this.destroyed = !1),
      ...
      (this.handleSessionMetadataUpdated = (i) => {
        ...
        new Map([
          ...
          [
            "ChainId",
            (d) => i.JsonRpcUrl && this.handleChainUpdated(d, i.JsonRpcUrl),
          ],
        ]).forEach((d, l) => {
          const f = i[l];
          f !== void 0 && d(f);
      ...
      (this.handleMetadataUpdated = async (i, a) => {
        ...
        (d = this.listener) === null || d === void 0 || d.metadataUpdated(i, l);
      }),
      ...
      (this.handleChainUpdated = async (i, a) => {
        ...
        (d = this.listener) === null || d === void 0 || d.chainUpdated(l, f);
      }),
      (this.session = e),
  ...
  heartbeat() {
    if (Date.now() - this.lastHeartbeatResponse > Ke * 2) {
      this.ws.disconnect();
      return;
    }
    try {
...
class Q {
  ...
  save() {
    return (
      this.storage.setItem(He, this.id),
      this.storage.setItem(ze, this.secret),
      this.persistLinked(),
      this
    );
  }
  persistLinked() {
    this.storage.setItem(Fe, this._linked ? "1" : "0");
  }
}
function dn() {
  try {
...
const bt = (t) =>
  ...
  wn = ({ autoExpand: t, message: e, menuItems: n }) => {
    const [s, r] = Ae(!0),
      [i, a] = Ae(t ?? !1);
    _t(() => {
      const l = [
...
class yn {
  constructor() {
    (this.attached = !1), (this.snackbar = new bn());
  }
  attach() {
    if (this.attached)
...
const En = ({
  ...
  In = "https://keys.coinbase.com/connect",
...
class Ye {
  ...
  redirectToCoinbaseWallet(e) {
    const n = new URL(Sn);
    n.searchParams.append("redirect_url", un().href),
...
class H {
  ...
  subscribe() {
    const e = Q.load(this.storage) || Q.create(this.storage),
      ...
      r = this.isMobileWeb ? new Ye() : new yn();
    ...
    const f = V(8),
      m = (I) => {
        this.publishWeb3RequestCanceledEvent(f),
          this.handleErrorResponse(f, d.method, I),
          l == null || l();
      };
    return (
      ...
      new Promise((I, u) => {
        this.relayEventManager.callbacks.set(f, (c) => {
          if ((l == null || l(), j(c))) return u(new Error(c.errorMessage));
          I(c);
        }),
          this.publishWeb3RequestEvent(f, d);
      })
    );
  }
    ...
    return (
      ...
      new Promise((d, l) => {
        this.relayEventManager.callbacks.set(i, (f) => {
          ...
          if (j(f)) return l(new Error(f.errorMessage));
          d(f);
        }),
...
const $e = "DefaultChainId",
  Ve = "DefaultJsonRpcUrl";
class wt {
  constructor(e) {
    (this._relay = null),
      (this._addresses = []),
      (this.metadata = e.metadata),
      (this._storage = new q("walletlink", Ge)),
  ...
  get jsonRpcUrl() {
    var e;
    return (e = this._storage.getItem(Ve)) !== null && e !== void 0
      ? e
      : void 0;
  }
  set jsonRpcUrl(e) {
    this._storage.setItem(Ve, e);
  }
  updateProviderInfo(e, n) {
    var s;
    this.jsonRpcUrl = e;
    const r = this.getChainId();
    this._storage.setItem($e, n.toString(10)),
      ne(n) !== r &&
        ((s = this.callback) === null ||
          s === void 0 ||
          s.call(this, "chainChanged", Y(n)));
  }
  async watchAsset(e) {
  ...
  async addEthereumChain(e) {
    ...
    const a = this.initializeRelay(),
      ...
      u = await a.addEthereumChain(i.toString(), d, m, l, f, I);
    if (j(u)) return !1;
    if (
      ((s = u.result) === null || s === void 0 ? void 0 : s.isApproved) === !0
    )
  ...
  _ensureKnownAddress(e) {
    const n = F(e);
    if (!this._addresses.map((r) => F(r)).includes(n))
  ...
  _prepareTransactionParams(e) {
    ...
    const s = e.to ? F(e.to) : null,
      ...
      i = e.data ? me(e.data) : Buffer.alloc(0),
      a = e.nonce != null ? ne(e.nonce) : null,
      d = e.gasPrice != null ? Z(e.gasPrice) : null,
      l = e.maxFeePerGas != null ? Z(e.maxFeePerGas) : null,
      f = e.maxPriorityFeePerGas != null ? Z(e.maxPriorityFeePerGas) : null,
      m = e.gas != null ? Z(e.gas) : null,
      I = e.chainId ? ne(e.chainId) : this.getChainId();
    return {
      fromAddress: n,
      toAddress: s,
      weiValue: r,
  ...
  getChainId() {
    ...
    return Number.parseInt(
      (e = this._storage.getItem($e)) !== null && e !== void 0 ? e : "1",
      10
    );
  }
...
const yt = "SignerType",
  mt = new q("CBWSDK", "SignerConfigurator");
function vn() {
  return mt.getItem(yt);
}
function _n(t) {
  mt.setItem(yt, t);
}
...
Please see https://www.smartwallet.dev/guides/tips/popup-tips#cross-origin-opener-policy for more information.`,
  ...
  { checkCrossOriginOpenerPolicy: Rn, getCrossOriginOpenerPolicy: Pn } = Mn(),
  Je = 420,
  Qe = 540;
function Tn(t) {
  const e = (window.innerWidth - Je) / 2 + window.screenX,
    n = (window.innerHeight - Qe) / 2 + window.screenY;
  Nn(t);
  const s = window.open(
    t,
    "Smart Wallet",
    `width=${Je}, height=${Qe}, left=${e}, top=${n}`
  );
  if ((s == null || s.focus(), !s))
...
function jn(t) {
  const e = Lt(Un(t), { shouldIncludeStack: !0 }),
...
class qn extends Bn {
  ...
  async request(e) {
    try {
        ...
        switch (e.method) {
          case "eth_requestAccounts": {
            const n = await this.requestSignerSelection(e),
              s = this.initSigner(n);
            await s.handshake(e), (this.signer = s), _n(n);
            break;
          }
          case "net_version":
            return 1;
      ...
      const { code: s } = n;
      return (
        s === D.provider.unauthorized && this.disconnect(),
        Promise.reject(jn(n))
      );
    }
  }
  ...
  async disconnect() {
    ...
    await ((e = this.signer) === null || e === void 0 ? void 0 : e.cleanup()),
      ...
      this.emit(
        "disconnect",
        A.provider.disconnected("User initiated disconnection")
      );
  }
...
function Hn(t) {
  ...
  return (e = zt(n)) !== null && e !== void 0 ? e : new qn(n);
}
const zn = { options: "all" };
function Yn(t) {
  var e;
  new q("CBWSDK").setItem("VERSION", ie), Rn();
  const s = {
    metadata: {
